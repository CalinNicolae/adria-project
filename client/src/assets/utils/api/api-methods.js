 ...
 */
function get(endpoint, queryParameters, baseUrl) {
    const requestOptions = {
        method: 'GET',
        headers: createRequestHeader(),
    };

    return call(endpoint, queryParameters, requestOptions, baseUrl);
}
 ...
 * @returns {Promise<Object>}
 */
async function call(endpoint, queryParameters, requestOptions, baseUrl = apiBaseUrl) {
    const queryParamString = createQueryParamString(queryParameters);
    const fullUri = baseUrl + endpoint + queryParamString;

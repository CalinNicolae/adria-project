...
- Access SonarQube reports:
  - [SonarQube Dashboard - Adria Server](https://sonarqube.ti.howest.be/dashboard?id=2024.ad-project.adria.05.server)
  - [SonarQube Dashboard - Adria Client](https://sonarqube.ti.howest.be/dashboard?id=2024.ad-project.adria.05.client)
...
- **Database**: 
  - Read-only access: [Production Database](https://project-2.ti.howest.be/monitor/dbs/group-05)
  - Open with JetBrains DataGrip or any SQLite viewer.
- **Server Logs**:
  - [Production Logs](https://project-2.ti.howest.be/monitor/logs/group-05)
- **Server API**:
  - [Production API](https://project-2.ti.howest.be/monitor/apis/group-05)
- **API Overview**:
  - [Adria API Overview](https://project-2.ti.howest.be/monitor/overview/)
  - Please complete the `openapi.yaml` to contribute.
- **Web Client Project**:
  - [Web Client Access](https://project-2.ti.howest.be/2024-2025/group-05/)

...
dependencies {
    ...
    testImplementation("org.bouncycastle:bcprov-jdk15on:$bcprovJdk15onVersion")
...
sonarqube {
    properties {
        property("sonar.projectKey", "2024.ad-project.adria.05.server")
        property("sonar.projectName", "2024.ad-project.adria.05.server")

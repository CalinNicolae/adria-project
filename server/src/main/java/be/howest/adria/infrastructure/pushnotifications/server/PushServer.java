...
public class PushServer implements EventNotifier {
    ...
    private final SubscriptionDb subscriptionDb;
    ...
    public void handleSubscription(RoutingContext ctx) {
        ...
        LOGGER.log(Level.INFO, "Subscription saved");
        sendPushMessage(subscription, "{\"title\": \"Welcome!\",\"message\": \"You are now subscribed to our notifications\"}");
        LOGGER.log(Level.INFO, "Push message sent");
    }

...
public class WebApiTestUtils { //NOSONAR: Mr. Blomme provided this code
    ...
    public static void assertResponseHeader(HttpResponse<String> response, String header, String expectedValue) {
        ...
        assertEquals(expectedValue, actualValue); //NOSONAR: Mr. Blomme provided this code
    }
        ...
        while (Instant.now().isBefore(end)) {
            try {
                ...
                if (response.statusCode() == 200)
                    return;
            } catch (Exception e) { //NOSONAR: Mr. Blomme provided this code
